...
export default function Hero() {
    ...
    const timer = setTimeout(() => {
      ...
      Events.on(engine, "collisionStart", (event) => {
        ...
        event.pairs.forEach(({ bodyA, bodyB, collision }) => {
          ...
          const isWall = bodyA.label === "wall" || bodyB.label === "wall" || bodyA.label === "ceiling" || bodyB.label === "ceiling";
  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen w-full overflow-hidden bg-white flex flex-col items-center justify-center pt-[100px] pb-16">
      {/* Grid background */}
      <div
      ...
      {/* Tag UI layer */}
      <div ref={uiRef} className="absolute inset-0 z-20" style={{ pointerEvents: "none" }} />

      {/* Name — lantai fisika */}
      <div className="relative z-10 w-full flex justify-center items-center pointer-events-none overflow-hidden">
        <h1 ref={nameRef} className="text-black font-black leading-[0.85] tracking-tighter whitespace-nowrap w-full text-center select-none" style={{ fontSize: "clamp(40px, 12.5vw, 260px)", maxWidth: "none", letterSpacing: "-0.02em" }}>
          {YOUR_NAME}
        </h1>
      </div>
      ...
      <div className="relative z-30 mt-8 flex flex-col items-center gap-5 px-4">
        <p className="text-gray-500 text-center text-lg md:text-xl font-medium max-w-md">{YOUR_TAGLINE}</p>
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://github.com/KrisnaUdayana"
            target="_blank"
            rel="noopener noreferrer"
            className="w-11 h-11 flex items-center justify-center border-[3px] border-black rounded-full bg-white text-black hover:bg-black hover:text-white transition-all shadow-[3px_3px_0_#111] hover:shadow-[4px_4px_0_#111] hover:-translate-y-0.5"
          >
            <FiGithub size={18} />
          </a>
          <a
            href="https://linkedin.com/in/krisnaudayana"
            target="_blank"
            rel="noopener noreferrer"
            className="w-11 h-11 flex items-center justify-center border-[3px] border-black rounded-full bg-white text-black hover:bg-black hover:text-white transition-all shadow-[3px_3px_0_#111] hover:shadow-[4px_4px_0_#111] hover:-translate-y-0.5"
          >
          ...
          <a
            href="https://instagram.com/krisnaudayana_"
            target="_blank"
            rel="noopener noreferrer"
            className="w-11 h-11 flex items-center justify-center border-[3px] border-black rounded-full bg-white text-black hover:bg-black hover:text-white transition-all shadow-[3px_3px_0_#111] hover:shadow-[4px_4px_0_#111] hover:-translate-y-0.5"
          >
